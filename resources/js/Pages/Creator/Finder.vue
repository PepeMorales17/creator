                ...
                <div class="intro-y flex flex-col-reverse sm:flex-row items-center">
                    <div class="w-full sm:w-auto relative mr-auto mt-3 sm:mt-0">
                        ...
                        <div class="inbox-filter dropdown absolute inset-y-0 mr-3 right-0 flex items-center" data-tw-placement="bottom-start">
                            <ChevronDownIcon class="dropdown-toggle w-4 h-4 cursor-pointer text-slate-500" role="button" aria-expanded="false" data-tw-toggle="dropdown" />
                            ...
                            <div class="dropdown-menu w-40">
                                <ul class="dropdown-content">
                                    <li>
                                        ...
                                        <Modal id="new-folder-modal" :toggle="{ is: 'a', class: 'dropdown-item cursor-pointer' }">
                                            <template #toggle><FolderPlusIcon class="w-4 h-4 mr-2" /> Nueva carpeta</template>
                                            <template #content="{ modal }">
                                                <label for="crud-form-1" class="form-label">Nombre del folder</label>
                                                <input id="crud-form-1" v-model="newFolderName" type="text" class="form-control w-full" placeholder="Nombre del folder" />
                                                <button
